...
/** GPS 흔들림보다 긴 최근 10m 이동의 시작→끝으로 보행 방향을 계산합니다. */
export const MIN_HEADING_MOVE_M = 10;
/** 한 번에 이보다 크게 꺾이면 GPS 튕김으로 보고 이번 값은 버립니다. */
export const MAX_HEADING_STEP_DEG = 75;
/** 보행보다 낮은 속도만 잠급니다. 화면과 카메라에서는 속도를 다시 판정하지 않습니다. */
export const MAP_ROTATE_LOCK_MPS = 0.55;
/** 이보다 작은 변화는 worker 한 곳에서만 무시합니다. */
export const CAMERA_BEARING_DEADZONE_DEG = 10;
